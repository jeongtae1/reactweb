    ...
    <>
      <Grid container spacing={2} whiteSpace="nowrap">
        ...
        <Grid item xs={6} sx={{ bgcolor: "#3f50b5" }}>
          <Link href="https://sports.news.naver.com/index">
            <Button sx={{ color: "#fff" }}>
              <Typography sx={{ fontWeight: "bold" }}>스포츠 홈</Typography>
            </Button>
          </Link>
